...
<html>
    ...
    <style>
       ...
       /*  body {
	background-image: url("images/skyeventlogoblue.jpg");
...
//elememt---> " element to be validated ".
    ...
    <center>
        ...
        <form action='booking' method='POST' id="bookevent">
            <div class="container ">
                <div class="jumbotron">
<div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control"  name="pno" value="<%=session.getAttribute("phno")%>">
                    </div>
                    <div class="form-group col-md-4">
                        <label >Email</label>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control"  name="ename" value="<%=s.getEname()%>" readonly>
                    </div>
                    <div class="form-group col-md-4">
                        <label >Event cost</label>
                        <input type="number" class="form-control"  name="ecost" value="<%=s.getCost()%>" readonly>
                    </div>
                    <div class="form-group col-md-4">
